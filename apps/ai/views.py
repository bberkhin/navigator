...
Для поиска программ ВСЕГДА используй функцию search_programs — не отвечай по памяти.
Для деталей программы ВСЕГДА используй get_program_detail. Ни чего не додумывай только из функций.
